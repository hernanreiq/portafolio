...
var p7 = new Proyecto("Funeraria Eternidad", "Web", "https://hernanreiq.github.io/funeraria-eternidad/", 4, "img/Funeraria Eternidad/", "El diseño de esta web se me ocurrió mientras hablaba con un compañero de la Universidad, donde le contaba que sería interesante tener una portada con un pasto verde simulando un cementerio, para luego al hacer scroll ir bajo tierra viendo ataudes, me pareció una idea muy creativa para una funeraria.", "HTML y CSS.", "No tuve interés en crear otras sub-páginas, es una maqueta sencilla.");
