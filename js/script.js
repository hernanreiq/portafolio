...
var p7 = new Proyecto("Visitas Promedio YT", "Extensión de navegador para Google Chrome", "https://github.com/hernanreiq/visitas-promedio-yt", 3, "img/Visitas Promedio YT/", "Esta extensión del navegador Google Chrome, la diseñe y desarrollé para uso personal. La extensión sirve para analizar el rendimiento de las visitas en un canal de YouTube, tomando como parámetro la cantidad actuales de suscriptores.", "HTML, CSS, JavaScript y JSON", "Extensión que calcula el promedio de visitas que deberia tener un canal en 48 horas.");
